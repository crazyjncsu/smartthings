...
metadata {
  ...
  preferences {
    ...
    details(["cameraDetails", "take", "up", "alarmStatus", "left", "stop", "right", "refresh", "down", "blank", "ledAuto", "ledOn", "ledOff", "preset1", "preset2", "preset3", "cruisemap1", "cruisemap2", "stopcruise"])
